        ...
        <el-row :gutter="15" style="height: 100%;">
            <el-col :span="4" style="height: 100%;">
                <div class="flex">
                    ...
                    <el-button size="small" @click="addType" type="primary" :icon="Plus">添加设备</el-button>
                </div>
            ...
            <el-col :span="20" style="height: 100%;">
                ...
                <el-scrollbar v-if="tableData.length > 0" style="height: calc(100% - 60px)" aria-orientation="vertical">
                            ...
                            <el-col :span="3" v-for="(data, i) in Prots.List">
                                <el-card shadow="hover" body-style="padding: 15px">
                                    ...
                                    <el-input v-model="data.Value" placeholder="值"
                                        :readonly="data.Type && data.Type != 0" />
                                    <el-input v-model="data.Name" placeholder="说明" />
                                </el-card>
                            </el-col>
                            <el-col :span="3">
    ...
    <el-dialog v-model="dialogFormVisible" title="参数配置" width="800">
        ...
        <el-table :data="Prots.Configs" table-layout="auto">
            ...
            <el-table-column label="长度">
                <template #default="scope">
                    <el-input-number v-model="scope.row.Len" autocomplete="off" min="1" style="width: 120px" />
                </template>
            </el-table-column>
...
const handleNodeClick = (data) => {
    var d = { ...data };
    Prots.Name = d.Name;
    var List = d.List?.map(d => { return { ...d } });
